...
public class POC3D implements Runnable {
	...
	public POC3D() {
		...
		p.setPreferredSize(new Dimension(GameUtilities.SC_WIDTH,
				GameUtilities.SC_HEIGHT));
	...
	public void run() {
		...
		Cursor transparent = tk.createCustomCursor(tk.getImage(""),
				new java.awt.Point(), "trans");
		...
		Plane p1 = new Plane(new Point(20, 0, 20), new Vector(1, 0, 0),
				Color.black);
		Plane p2 = new Plane(new Point(-20, 0, 20), new Vector(1, 0, 0),
				Color.blue);
		Plane p3 = new Plane(new Point(0, 0, 20), new Vector(0, 0, 1),
				Color.cyan);
		Plane p4 = new Plane(new Point(0, 0, 0), new Vector(0, 1, 0),
				Color.orange);
		Plane p5 = new Plane(new Point(0, 0, -20), new Vector(0, 0, 1),
				Color.green);
		Plane p7 = new TexturedPlane(new Point(1, 6, 1), new Vector(0, 1, 0),
				GameUtilities.loadImage("resources/kitten.jpg"));
		Plane p8 = new TexturedPlane(new Point(22, 0, 50),
				new Vector(0, -1, 1),
				GameUtilities.loadImage("resources/xmas.jpg"));
		{
			Point a = new Point(0, 0, 0), b = new Point(0, 1, 0), c = new Point(
					1, 0, 0);
		...
		{
			Point a = new Point(5, 1, 5), b = new Point(5, 1, 1.5), c = new Point(
					1, 0, 5);
		...
		{
			Point a = new Point(0, 1, 0), b = new Point(0, 1, 1), c = new Point(
					1, 1, 0);
		...
		{
			Point a = new Point(1, 1, 0), b = new Point(1, 1, 1), c = new Point(
					0, 1, 1);
	...
	class MouseMovementListener implements MouseListener, MouseMotionListener,
		...
		public void recenter() {
			if (mouseCaptured) {
				java.awt.Point p = new java.awt.Point(j.getWidth() / 2,
						j.getHeight() / 2);
		...
		public void mouseMoved(MouseEvent arg0) {
			...
			if (arg0.getX() != j.getWidth() / 2
					|| arg0.getY() != j.getHeight() / 2) {
				p.mouseMoved(arg0.getX() - j.getWidth() / 2,
						arg0.getY() - j.getHeight() / 2);
				recenter();
			}
		}
